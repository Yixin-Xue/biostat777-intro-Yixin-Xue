...
::: {.container style="display: flex; align-items: flex-start; justify-content: center; gap: 30px;"}

<img src="images/me.jpg" alt="Yixin baking bread rolls" width="40%" style="border-radius: 12px; margin-top: 0;"/>
